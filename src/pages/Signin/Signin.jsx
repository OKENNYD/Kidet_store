...
const Signin = () => {
  ...
  let formik = useFormik({
    ...
    validationSchema: yup.object({
      ...
      password: yup.string().required('Required').max(10,'not a valid mail')
    }),
    onSubmit: (values) => {
    ...
    <div className="w-full h-fit">
      ...
      <div className="w-full h-fit flex justify-center items-center py-24">
        <div className="form rounded-3xl bg-white dark:bg-slate-800 w-80 h-auto flex-col py-8 justify-center items-center m-auto">
          ...
          />
          <form
            className=" h-auto w-full caret-blue-600 p-6 pb-2 grid gap-3"
          ...
          >
            ...
            <p className="text-gray-800 dark:text-gray-200 text-right">
              <Link to="terms" className="text-sm w-full">
                Forgotten password?
              </Link>
            </p>
            <button
